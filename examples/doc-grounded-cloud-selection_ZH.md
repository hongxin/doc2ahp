...
> **核心 AHP 概念**：文档驱动的准则提取（Mode A）—— 准则从实际项目文档中提取并标注来源 `[D1 §5]`，τ 过滤器移除不相关准则，每项评分均有证据支撑。这正是论文核心的 "Doc → AHP" 流水线。
...
| 对比 | 合规与安全 | 技术适配性 | 医疗生态系统 | 成本与团队 |
|----|-----------|---------|-----------|---------|
| 合规与安全 | 1 | 1.57 | 1.57 | 2.59 |
| 技术适配性 | 0.64 | 1 | 0.84 | 1.57 |
| 医疗生态系统 | 0.64 | 1.19 | 1 | 1.57 |
| 成本与团队 | 0.39 | 0.64 | 0.64 | 1 |

### 权重计算

| 准则 | 行几何均值 | 归一化权重 |
|-----|-----------|----------|
| 合规与安全 | 1.58 | 0.38 ×（已应用约束） |
| 技术适配性 | 0.97 | 0.27 |
| 医疗生态系统 | 1.05 | 0.20 |
| 成本与团队 | 0.60 | 0.15 |

**共识权重**（已应用"合规不可妥协"约束，提升 2 个等级）：
...
| 审计日志与访问 | 0.11 | 9 | 8 | 6 | [D4] AWS CloudTrail 最成熟；GCP 审计日志覆盖度较弱 |
...
| 排名 | 方案 | 得分 | 核心优势 |
|-----|------|------|---------|
| 1 | AWS | 8.56 | 最成熟的 HIPAA 工具链，团队匹配度最高，合规认证最广泛 |
| 2 | Azure | 8.03 | 最佳医疗专属生态系统（FHIR、医疗 AI），企业合规性强 |
| 3 | GCP | 7.94 | 最佳托管 Kubernetes，价格有竞争力，但医疗专属服务最薄弱 |
